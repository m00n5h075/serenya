...
exports.getCurrentHandler = async (event) => {
  ...
  try {
    ...
    console.log('Fetching active subscription for user...');
    let subscription;
    try {
    ...
    // If no active subscription found, return default "free" subscription
    if (!subscription) {
      console.log('No active subscription found, returning free tier defaults');
    ...
    // Format active subscription for frontend
    const subscriptionResponse = {
      ...
      auto_renew: subscription.subscription_status === 'active', // Assume active means auto-renew
