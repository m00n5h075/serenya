...
exports.getCurrentHandler = async (event) => {
  ...
  try {
    ...
    if (!subscription) {
      ...
      auditLog('subscription_not_found', userId, { 
        has_subscription: false 
      });
      
      return createErrorResponse(404, 'NO_SUBSCRIPTION_FOUND', 'No subscription found for user', 'User has no subscription records');
    }
